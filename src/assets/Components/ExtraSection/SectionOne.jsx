...
const SectionOne = () => {
    return (
        <div className='mx-auto mt-10 py-10 lg:px-14 px-5  space-y-8 '>
        <h2 className='lg:text-4xl text-2xl text-center text-gray-600 font-bold'>How Crowdfunding Works</h2>
        <p className='text-xl text-center '>Crowdfunding is a way to raise money for a specific cause or project by gathering small contributions from a large number of people, usually through an online platform.</p>
       
        <div className='space-y-4 lg:flex lg:justify-between gap-5 p-2 border-2 rounded-xl '>
          
          <div className='lg:w-[700px] mt-5'>
          <h3 className='lg:text-3xl text-xl'>Setting Up a Campaign</h3>
        ...
        <div>
          ...
          <h3 className='lg:text-3xl text-xl'>Crowdfunding Goal</h3>
            <ol className='space-y-5 mt-5'>
        ...
        <div className='space-y-4 lg:flex lg:justify-between border-2 rounded-xl gap-5 p-2 '>
          <div className='lg:w-[1000px] mt-5'>
          <h3 className='lg:text-3xl text-xl'>Donating to the Campaign</h3>
